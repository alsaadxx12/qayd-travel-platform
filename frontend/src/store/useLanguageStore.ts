...
const translations: Record<Language, Record<string, string>> = {
  ar: {
    ...
    'nav.employee-salaries': 'الرواتب والأجور',
    'nav.employee-points': 'نقاط وتحفيز الموظفين',
    'nav.employee-attendance': 'سجل الحضور والانصراف',
    'nav.employee-leaves': 'طلبات الإجازات',
    'nav.employee-competitions': 'مسابقات وتحديات الموظفين',
  ...
  en: {
    ...
    'nav.employee-salaries': 'Salaries & Payroll',
    'nav.employee-points': 'Points & Incentives',
    'nav.employee-attendance': 'Attendance Records',
    'nav.employee-leaves': 'Leave Requests',
    'nav.employee-competitions': 'Competitions & Challenges',
