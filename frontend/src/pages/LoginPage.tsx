...
const LOGIN_SLIDES = {
  ar: [
    {
      id: 'vr-analysis',
      eyebrow: 'التحليلات والمؤشرات المالية المتقدمة',
      title: '«رؤية استشرافية دقيقة لتدفقاتك المالية وأسعار الصرف»',
      subtitle: 'تحليلات ذكية ومخططات لحظية لأسعار العملات وهوامش الأرباح والسيولة.',
      formula: 'ROI = (Gain - Cost) / Cost',
      formulaDesc: 'مؤشر العائد على الاستثمار',
      author: 'منظومة QAYD الذكية',
      image: '/illustrations/vr-analysis.svg',
      imageType: 'illustration',
    },
    {
      id: 'data-presentation',
      eyebrow: 'بوابة العمليات المالية المتكاملة',
      ...
      image: '/illustrations/data-presentation.svg',
      imageType: 'illustration',
    },
    {
      id: 'business-planning',
      eyebrow: 'التخطيط والنمو المالي',
      title: '«تخطيط مالي استراتيجي يقود شركتك نحو نمو مستدام»',
      subtitle: 'موازنات تقديرية، تقارير أرباح وخسائر، وتتبع ديون في الوقت الفعلي.',
      formula: 'NPV = ∑ [R_t / (1+i)^t]',
      formulaDesc: 'القيمة الحالية لصافي التدفقات',
      author: 'إدارة الحسابات الاستراتيجية',
      image: '/illustrations/business-planning.svg',
      imageType: 'illustration',
    },
    {
      id: 'organizing-papers',
      eyebrow: 'الأرشفة وضبط المستندات',
      title: '«تنظيم آلي للسندات والوصولات والقيود المحاسبية»',
      subtitle: 'إرفاق الوصولات إلكترونياً وتوثيق كافة العمليات المالية بدقة متناهية.',
      formula: '∑ Debits = ∑ Credits',
      formulaDesc: 'ميزان المراجعة وتوازن القيد',
      author: 'دفتر القيود والأرشفة',
      image: '/illustrations/organizing-papers.svg',
      imageType: 'illustration',
    },
    {
      id: 'startup-team',
      eyebrow: 'العمل الجماعي وإدارة الفروع',
      title: '«فريق عمل متناغم مع إدارة دقيقة للصلاحيات والمطابقات»',
      subtitle: 'ربط الفروع والصناديق الفرعية ومتابعة تسويات التحصيل لحظة بلحظة.',
      formula: 'Productivity = Output / Input',
      formulaDesc: 'معادلة كفاءة وإنتاجية الفريق',
      author: 'إدارة الفروع والصلاحيات',
      image: '/illustrations/startup-team.svg',
      imageType: 'illustration',
    },
    {
      id: 'einstein-1',
  ...
  en: [
    {
      id: 'vr-analysis',
      eyebrow: 'Advanced Financial Analytics',
      title: '“A sharp foresight into financial flows & exchange rates”',
      subtitle: 'Smart real-time charts for market rates, margins, and enterprise liquidity.',
      formula: 'ROI = (Gain - Cost) / Cost',
      formulaDesc: 'Return on Investment Metric',
      author: 'QAYD Intelligence Hub',
      image: '/illustrations/vr-analysis.svg',
      imageType: 'illustration',
    },
    {
      id: 'data-presentation',
      eyebrow: 'Integrated Operations Hub',
    ...
    {
      id: 'business-planning',
      eyebrow: 'Strategic Financial Planning',
      title: '“Strategic financial planning driving sustainable growth”',
      subtitle: 'Budgeting, P&L statements, and real-time debt tracking across branches.',
      formula: 'NPV = ∑ [R_t / (1+i)^t]',
      formulaDesc: 'Net Present Value of Cash Flows',
      author: 'Strategic Finance Dept',
      image: '/illustrations/business-planning.svg',
      imageType: 'illustration',
    },
    {
      id: 'organizing-papers',
      eyebrow: 'Document & Ledger Organization',
      title: '“Automated organization of vouchers, receipts, and entries”',
      subtitle: 'Electronic attachment of receipts and seamless audit logging for all transactions.',
      formula: '∑ Debits = ∑ Credits',
      formulaDesc: 'Trial Balance Equilibrium',
      author: 'General Ledger & Archiving',
      image: '/illustrations/organizing-papers.svg',
      imageType: 'illustration',
    },
    {
      id: 'startup-team',
      eyebrow: 'Teamwork & Branch Governance',
      title: '“Collaborative teamwork with precise branch & role governance”',
      subtitle: 'Connect branches, sub-cashboxes, and monitor settlements in real time.',
      formula: 'Productivity = Output / Input',
      formulaDesc: 'Team Efficiency & Output Rate',
      author: 'Branch & Permission System',
      image: '/illustrations/startup-team.svg',
      imageType: 'illustration',
    },
    {
